...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KomMonitorInstanceType', function() {
      beforeEach(function() {
        instance = new KomMonitorHarvesterApi.KomMonitorInstanceType();
      });

      it('should create an instance of KomMonitorInstanceType', function() {
        // TODO: update the code to test KomMonitorInstanceType
        expect(instance).to.be.a(KomMonitorHarvesterApi.KomMonitorInstanceType);
      });
