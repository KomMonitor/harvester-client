...
exports.IndicatorDataMappingType = void 0;
 ...
 * @version 0.0.1
 */
var IndicatorDataMappingType = /*#__PURE__*/function (_SpatialDataMappingTy) {
  _inherits(IndicatorDataMappingType, _SpatialDataMappingTy);

  var _super = _createSuper(IndicatorDataMappingType);
   ...
   */
  function IndicatorDataMappingType() {
    _classCallCheck(this, IndicatorDataMappingType);
  ...
  _createClass(IndicatorDataMappingType, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('indicatorSpatialUnitMappingDefs')) obj.indicatorSpatialUnitMappingDefs = _ApiClient.ApiClient.convertToType(data['indicatorSpatialUnitMappingDefs'], [_IndicatorSpatialUnitMappingType.IndicatorSpatialUnitMappingType]);
      }
  ...
  return IndicatorDataMappingType;
...
exports.IndicatorDataMappingType = IndicatorDataMappingType;
